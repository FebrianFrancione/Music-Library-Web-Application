...
Web-Application that allows a client to create an Album/Artist and upload Cover Images.
Implements CRUD requests following MVC Pattern and RESTful architecture. Controller allows for Response to return JSON for Postman Requests and HTTP to web browser. 
